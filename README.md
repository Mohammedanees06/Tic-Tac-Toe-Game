Tic Tac Toe game implemented using HTML, CSS, and JavaScript. This project features a responsive 3x3 grid, dynamic gameplay for two players, and basic win-draw detection logic
